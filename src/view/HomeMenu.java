...
import Controller.ControllerBrand;
...
public class HomeMenu extends javax.swing.JFrame {
    ...
    private void jMenuItemBrandActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemBrandActionPerformed
        ViewBrand viewBrand = new ViewBrand(null, true);
        ControllerBrand controller = new ControllerBrand(viewBrand);
        viewBrand.setLocationRelativeTo(null);
        viewBrand.setVisible(true);
